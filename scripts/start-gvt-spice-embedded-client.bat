...
"%PYEXE%" ".\direct-stream\start_gvt_stream_qemu.py" start --restart --port 5004 --rtp-mtu 1400 --fps 60 --bitrate 18000 --video-codec %VIDEO_CODEC% --keyint 60 --capture-ms 16 --idle-capture-ms 16 --idle-after-ms 0 --idle-probe-ms 0 --fec 0 --fec-important 0
start "GVT SPICE Embedded Client" ".\direct-stream\client\gvt_spice_viewer.exe" --video-codec %VIDEO_CODEC% --video-port 5004 --latency %VIDEO_LATENCY% --spice-host 192.168.0.188 --spice-port 5900 --native-input --invert-case --input-host 192.168.0.188 --input-port 5905 --source-width %SOURCE_WIDTH% --source-height %SOURCE_HEIGHT% --auto-size
