...
"%PYEXE%" ".\direct-stream\start_gvt_stream_qemu.py" start --restart --port 5004 --fps 60 --bitrate 18000 --video-codec %VIDEO_CODEC% --capture-ms 16 --idle-capture-ms 66 --idle-after-ms 1500 --idle-probe-ms 500 --idle-changed-ppm 3000 --idle-pixel-delta 8 --fec 0 --fec-important 0
if errorlevel 1 (
    set "CLIENT_EXIT=1"
    goto cleanup
)
